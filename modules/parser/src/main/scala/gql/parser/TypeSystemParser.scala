...
object TypeSystemParser {
  ...
  lazy val enumTypeDefinition: P[TypeDefinition.EnumTypeDefinition] =
    ((stringValue.?.with1 <* s("enum")) ~ name ~ enumValueDefinition.rep).map{ case ((d, n), vs) => TypeDefinition.EnumTypeDefinition(d, n, vs) }

  lazy val scalarTypeDefinition: P[TypeDefinition.ScalarTypeDefinition] =
    ((stringValue.?.with1 <* s("scalar")) ~ name).map{ case (d, n) => TypeDefinition.ScalarTypeDefinition(d, n) }
  ...
  lazy val objectTypeDefinition: P[TypeDefinition.ObjectTypeDefinition] =
    ((stringValue.?.with1 <* s("type")) ~ name ~ implementsInterface.? ~ fieldDefinition.rep.between(t('{'), t('}')))
  ...
  lazy val interfaceTypeDefinition: P[TypeDefinition.InterfaceTypeDefinition] =
    ((stringValue.?.with1 <* s("interface")) ~ name ~ implementsInterface.? ~ fieldDefinition.rep.between(t('{'), t('}')))
  ...
  lazy val unionTypeDefinition: P[TypeDefinition.UnionTypeDefinition] =
    ((stringValue.?.with1 <* s("union")) ~ name ~ (s("=") *> name.repSep(t('|'))))
  ...
  lazy val inputObjectTypeDefinition: P[TypeDefinition.InputObjectTypeDefinition] =
    ((stringValue.?.with1 <* s("input")) ~ name ~ inputValueDefinition.rep.between(t('{'), t('}')))
