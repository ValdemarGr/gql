...
// brState: cats.data.package.State[gql.SchemaState[IO], BatchResolver[IO, Set[Int], Map[Int, Int]]] = cats.data.IndexedStateT@394ef931
```
...
// res2: data.IndexedStateT[Eval, SchemaState[IO], SchemaState[IO], DomainBatchers[[A]IO[A]]] = cats.data.IndexedStateT@4d4d92c8
```
...
// res4: String = "duration was 1012ms"
...
// emitting for user john_doe
// emitting for user john_doe
// Disconnecting from VPN after 655ms for john_doe ...
// res5: String = "duration was 660ms"
...
// res6: String = "duration was 560ms"
