...
// brState: cats.data.package.State[gql.SchemaState[IO], BatchResolver[IO, Set[Int], Map[Int, Int]]] = cats.data.IndexedStateT@2de4ff02
```
...
// res3: data.IndexedStateT[Eval, SchemaState[IO], SchemaState[IO], DomainBatchers[[A]IO[A]]] = cats.data.IndexedStateT@8eb582d
```
...
// emitting for user john_doe
// emitting for user john_doe
// Disconnecting from VPN after 720ms for john_doe ...
...
// emitting for user john_doe
// emitting for user john_doe
// Disconnecting from VPN after 1043ms for john_doe ...
// res5: String = "duration was 1083ms"
...
// res6: String = "duration was 724ms"

bench(runVPNSubscription(subscriptionQuery, 1)).unsafeRunSync()
// Connecting to VPN for john_doe ...
// Connected to VPN for john_doe!
// emitting for user john_doe
// Disconnecting from VPN after 580ms for john_doe ...
// res7: String = "duration was 630ms"
...
// Disconnecting from VPN after 1161ms for token-john_doe-0 ...
...
// Disconnecting from VPN after 610ms for token-john_doe-1 ...
