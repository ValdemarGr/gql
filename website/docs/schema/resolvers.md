...
// brState: cats.data.package.State[gql.SchemaState[IO], BatchResolver[IO, Set[Int], Map[Int, Int]]] = cats.data.IndexedStateT@459eaae1
```
...
// res3: data.IndexedStateT[Eval, SchemaState[IO], SchemaState[IO], DomainBatchers[[A]IO[A]]] = cats.data.IndexedStateT@178bf00d
```
...
// res5: String = "duration was 1045ms"
...
// emitting for user john_doe
// emitting for user john_doe
// Disconnecting from VPN after 661ms for john_doe ...
// res6: String = "duration was 676ms"

bench(runVPNSubscription(subscriptionQuery, 1)).unsafeRunSync()
// Connecting to VPN for john_doe ...
// Connected to VPN for john_doe!
// emitting for user john_doe
// Disconnecting from VPN after 554ms for john_doe ...
// res7: String = "duration was 560ms"
...
// Disconnecting from VPN after 1169ms for token-john_doe-0 ...
